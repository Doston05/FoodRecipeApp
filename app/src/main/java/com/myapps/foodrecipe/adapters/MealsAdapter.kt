...
class MealsAdapter :RecyclerView.Adapter<MealsAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(var binding:MealItemsBinding):RecyclerView.ViewHolder(binding.root)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(MealItemsBinding.inflate(LayoutInflater.from(parent.context),parent,false))
    }
